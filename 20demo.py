...
# a and b are integers and c is a floating-point number

# to change how to separate variables when printed out
...
# to ensure your function receives a correct value, use assert()
def pythagoras(a, b):
...
def neg(i):         # positive to negative
...
def ccarea(r):      # area of a circle
	assert(r > 0)
	area = math.pi * r ** 2
	return area
print('the area of this circle is: ' + str(ccarea(2)))

def tricr(a, b, c):    # circumferences of a triangle
...
def sphvol(r):      # volume of a sphere
	...
	vol =  (4/3) * math.pi * (r**3)
	return vol
print('the volume of the sphere is: ' + str(sphvol(3)))
